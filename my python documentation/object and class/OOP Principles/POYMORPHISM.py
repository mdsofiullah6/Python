'''
ploymorphism in python defines methods in the child class that have the same name as
...
however, it is possible to modify a method in a child class that is has inherited from the 
parent class. this is particularly useful in case where the method in the child class.
This process of reimplementing a method in the child class in known as 
Method Overriding.
